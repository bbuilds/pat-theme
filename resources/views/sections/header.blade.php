  ...
  <div class="container mx-auto px-4 flex items-center justify-between md:px-0">
    ...
    @if (has_nav_menu('primary_navigation'))
      <nav class="nav-primary" aria-label="{{ wp_get_nav_menu_name('primary_navigation') }}">
        <button class="md:hidden" aria-haspopup="true" aria-label="Open menu" data-micromodal-trigger="modal-primary-navigation"><svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><rect x="4" y="7.5" width="16" height="1.5"></rect><rect x="4" y="15" width="16" height="1.5"></rect></svg></button>
        <div id="modal-primary-navigation" class="modal menu-modal transition-all duration-300 ease-in-out fixed right-0 left-0 bottom-0 top-0 flex flex-col z-50 px-6 py-8 bg-white translate-x-full delay-150 md:block md:relative md:w-full md:translate-x-0 overflow-visible" aria-hidden="true">
